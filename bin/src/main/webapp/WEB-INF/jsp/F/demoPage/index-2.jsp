                    ...
                    <div class="product__banner-inner p-absolute fix d-none d-lg-block">
                        <div class="product__banner-img">
                            <a href="product-details.html"><img
                                    src="${contextRoot}/static/front/assets/img/shop/product/product-big-1.jpg"
                                    alt="product-banner"></a>
                        </div>
                        <div class="product__banner-content p-absolute">
                            <h4><a href="product-details.html">Creative Design <br>Juicy Pendant
                                Lamp</a></h4>
                            <a href="product-details.html" class="link-btn">discover now</a>
                        </div>
                    </div>
                        ...
                        <div class="sale__area-slider-2 owl-carousel">
                            <div class="sale__item">
                                <div class="product__wrapper mb-60">
                                    ...
                                    <div class="product__content p-relative">
                                        <div class="product__content-inner">
                                            <h4><a href="shop-details.html">Wooden container
                                                Bowl</a></h4>
                                            <div class="product__price transition-3">
                                                <span>$96.00</span>
                                                <span class="old-price">$96.00</span>
