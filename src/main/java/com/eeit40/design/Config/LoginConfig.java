...
public class LoginConfig implements WebMvcConfigurer {
  ...
  public void addInterceptors(InterceptorRegistry registry) {
    ...
    registrationFront.addPathPatterns("/F/shoppingcart","/F/orderrecord","/F/addDesignService","/F/editDesignService","/F/UpdateCase","/F/addshoppingcart","/F/Fmemberupdate","/F/ProductReview/insertProductReview"); // 攔截 路徑
