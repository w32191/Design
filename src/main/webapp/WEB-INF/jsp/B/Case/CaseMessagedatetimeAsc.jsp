                                ...
                                <div class="col-lg-12">
                                    <div class="card">
                                        <div class="card-title">
                                            <h4>Table Basic </h4>
                                            <button class="btn mini blue" type="submit">類別</button>
                                            <button class="btn mini blue" type="submit">地區</button>
                                            <button class="btn mini blue" type="submit">創建時間</button>
                                            <button class="btn mini blue" type="submit">結束時間</button>
                                                ...
                                                <table class="table">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th>E-mail</th>
                                                            <th>資訊</th>
                                                            <th><a href="${contextRoot}/B/Case/CaseMessagedatetimeDesc">創建時間</a></th>
                                                            <th>結束時間</th>
                                                        </tr>
                                                    </thead>
                                                    <tbody>
                                                        <c:forEach  var="caseMessage" items="${oldest}">
                                                         <tr>
                                                            ...
                                                            <td><fmt:formatDate pattern="yyyyMMdd" value="${caseMessage.dateTime}"/>
                                                            </td>
                                                            <td><fmt:formatDate pattern="yyyyMMdd" value="${caseMessage.expiryDate}"/>
                                                            </td>
