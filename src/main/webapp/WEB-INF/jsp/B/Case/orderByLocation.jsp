                                            ...
                                            <div class="table-responsive">
                                                <table class="table">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <th>標題</th>
                                                        <th><select style="border: none" id="classificationData" class="btn-group"></select></th>
                                                        <th><select style="border: none" id="locationData" class="btn-group"></select></th>
                                                        <th>E-mail</th>
                                                        <th>資訊</th>
                                                        <th>
                                                    ...
                                                    <c:forEach var="caseMessage" items="${findAll}">
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a href="find/${caseMessage.id}" class="btn btn-warning">編輯</a>
                                                            </td>
                                                            <td>
                                                                <button type="button"
