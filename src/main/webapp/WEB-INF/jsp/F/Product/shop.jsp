                                                ...
                                                <div class="card-body">
                                                    <div class="categories__list">
                                                        <ul>
                                                            ...
                                                            <li><a href="/Design/F/product/productbycategories?cate=Lounge Chair">休閒椅 Lounge Chair</a></li>
                                                            <li><a href="/Design/F/product/productbycategories?cate=Side Chairs">無扶手椅 Side Chairs</a></li>
                                                            <li><a href="/Design/F/product/productbycategories?cate=Kids Stuff">兒童桌椅 Kids Stuff</a></li>
                                                            <li><a href="/Design/F/product/productbycategories?cate=Cupboards">櫃 子 Cupboards</a></li>
                                                            <li><a href="/Design/F/product/productbycategories?cate=Sofa & Bed">沙 發, 床組 Sofa & Bed</a></li>
                                                            <li><a href="/Design/F/product/productbycategories?cate=Bar Stools">高腳椅 Bar Stools</a></li>
                                                            <li><a href="/Design/F/product/productbycategories?cate=Office Chairs">辦公椅 Office Chairs</a></li>
                                                        </ul>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="card">
                                            ...
                                            <div id="collapsecloth" class="collapse"
                                                ...
                                                <div class="card-body">
                                                    <div class="categories__list">
                                                        <ul>
                                                            <li><a href="/Design/F/product/productbycategories?cate=Table Lamps">桌 燈 Table Lamps</a></li>
                                                            <li><a href="/Design/F/product/productbycategories?cate=Desk Lamps">檯 燈 Desk Lamps</a></li>
                                                            <li><a href="/Design/F/product/productbycategories?cate=Floor Lamps">立 燈 Floor Lamps</a></li>
