...
$(function () {
    ...
    $('body').on('click', 'button[name="edit"]', function () {
        ...
        $.ajax({
            ...
            success: function (data) {
                $('#id_e').val(data.id);
                $('#question_type_e').val(data.questionType.id);
                console.log(data);
    ...
    function insertSend() {
        ...
        $.ajax({
            type: "POST",
            url: "/Design/B/CommonQuestion/api/postCase",
            data: dataFile,
    ...
    $("#locationData").change(function () {
        ...
        let locationText = $("#locationData > option:selected").text();
        let locationValue = $('#locationData > option:selected').val();
